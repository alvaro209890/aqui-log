...
| — | `UX-02` | `DONE` (2026-08-22) | P1 | Absorvido pela onda 1: QA de app no emulador (`QA-01`) e QA de painel no Playwright (`QA-02`), ligados no portão (`QA-03`) | evidência: `docs/04-status/entregas/2026-08-22-EVIDENCIA-QA-03.md`; plano: [`../05-execucao-autonoma/10-ONDA-1-QA-AUTOMATIZADO.md`](../05-execucao-autonoma/10-ONDA-1-QA-AUTOMATIZADO.md) |
...
| — | `QA-03` | `DONE` (2026-08-22) | P0 | Portão completo: `pnpm qa`, roundtrip de migration com linha legada, job Playwright no CI; emulador no runner documentado como fora | evidência: `docs/04-status/entregas/2026-08-22-EVIDENCIA-QA-03.md` |
...
- **`QA-03`** — `DONE` (2026-08-22). Portão `pnpm qa` + roundtrip + CI Playwright. Evidência: `docs/04-status/entregas/2026-08-22-EVIDENCIA-QA-03.md`.
- **`ADMIN-01`** — próxima da onda 2: motivo obrigatório, `audit_logs` completo, matriz de permissões, confirmação dupla. **Não pegar `FROTA-*`.**
